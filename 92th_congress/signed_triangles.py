...
# Constants
edgeFile = script_dir / f"{congress_code}_edges.csv"
outputFile = script_dir / f"{congress_code}_triangle_counts.csv"
...
triangle_df.to_csv(script_dir / f"{congress_code}_all_triangles.csv", index=False)
print(f"Saved full triangle list to: {script_dir / f'{congress_code}_all_triangles.csv'}")
