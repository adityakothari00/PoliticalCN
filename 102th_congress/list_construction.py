...
votes_path = script_dir / f"{congress_code}_votes.csv"
...
members_path = script_dir / f"{congress_code}_members.csv"
...
nodes_df.to_csv(script_dir / f"{congress_code}_nodes.csv", index=False)
edges_df.to_csv(script_dir / f"{congress_code}_edges.csv", index=False)
